...
@php
    ...
    $totalStatutories = (float) str_replace(',', '', $sss)
                      + (float) str_replace(',', '', $philhealth)
                      + (float) str_replace(',', '', $pagibig);
@endphp
...
<table class="payslip-table">
    ...
    <tbody>
        ...
        {{-- ✅ TOTAL DEDUCTIONS with value | EMPLOYEES STATUTORIES --}}
        <tr class="row-yellow">
            <td style="background:#fef9c3;color:#854d0e;font-weight:700;">TOTAL DEDUCTIONS</td>
            <td style="background:#fef9c3;color:#991b1b;font-weight:700;">₱ {{ $total_deductions }}</td>
            <td colspan="2" style="background:#fee2e2;color:#991b1b;border-left:1px solid #fecaca;font-weight:700;">EMPLOYEES STATUTORIES</td>
        </tr>
        ...
        {{-- Pag-IBIG | Signature name --}}
         <tr>
            ...
            <td colspan="2" class="rlbl" style="text-align:center;font-weight:700;border-left:1px solid #e5e7eb;">
        ...
        <tr>
            ...
            <td colspan="2" style="text-align:center;font-size:10px;color:#888;font-weight:400;border-left:1px solid #e5e7eb;">
