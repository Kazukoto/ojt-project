...
@if(Session::has('user_id') && Session::get('role_id') == 1)
            ...
            <div class="table-wrapper">
                <table class="data-table" id="rolesTable">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="no-data">No roles found. Click "Add Role" to create one.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div id="addProjectModal" class="modal-overlay">
        <div class="modal-box">
            ...
            <form method="POST" action="{{ route('superadmin.projects.store') }}">
                @csrf
                <div class="form-group">
    ...
    <script>
        ...
        function openEditModal(id, roleName, description, hourlyRate) {
            ...
            document.getElementById('editForm').action = `/superadmin/rolemanagement/${id}`;
            showModal('editModal');
        }
        ...
        function confirmDelete(id, roleName) {
            if (confirm(`Are you sure you want to delete the role "${roleName}"?\n\nThis action cannot be undone.`)) {
                ...
                form.action = `/superadmin/rolemanagement/${id}`;
                form.submit();
            }
        }
        ...
        function openEditProjectModal(id, name, description) {
            ...
            document.getElementById('editProjectForm').action = `/superadmin/projects/${id}`;
        ...
        function confirmDeleteProject(id, name) {
            if (confirm(`Are you sure you want to delete the project "${name}"?\n\nThis action cannot be undone.`)) {
                ...
                form.action = `/superadmin/projects/${id}`;
                form.submit();
            }
        }
