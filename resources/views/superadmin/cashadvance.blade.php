...
@if(Session::has('user_id') && Session::get('role_id') == 1)
    ...
    <div class="main-content">
        ...
        <div id="tab-cashadvance" class="tab-panel {{ request('tab') !== 'statutory' ? 'active' : '' }}">
            ...
            <!-- Filter + Add -->
            <form method="GET" action="{{ route('superadmin.cashadvance') }}" class="filter-form-row">
        ...
        <div id="tab-statutory" class="tab-panel {{ request('tab') === 'statutory' ? 'active' : '' }}">
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:16px; flex-wrap:wrap;">
                <form action="{{ route('superadmin.cashadvance') }}" method="GET"
    ...
    <div id="cashAdvanceModal" class="modal-overlay" style="display:none;">
        <div class="modal-box">
            ...
            <hr>
            <form method="POST" action="{{ route('superadmin.cashadvance.store') }}" id="cashAdvanceForm">
                @csrf
                <table>
                    <tbody>
                        <tr>
    ...
    <script>
        ...
        function editCashAdvanceModal(id) {
            fetch(`/superadmin/cashadvance/${id}/modal`, {
            ...
            .then(data => {
                ...
                document.getElementById('editCashAdvanceForm').action = `/superadmin/cashadvance/${id}`;
        ...
        function confirmDelete(id) {
            ...
            form.action = `/superadmin/cashadvance/${id}`;
            form.submit();
        }
