...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="d-flex gap-4 mb-3 flex-wrap">
            ...
            <span class="legend-item"><span class="legend-dot" style="background:#fd7e14"></span>Special
                Non-Working</span>
    ...
    {{-- POST store form --}}
    <form id="postForm" action="{{ route('timekeeper.holiday.store') }}" method="POST" style="display:none">
        @csrf
