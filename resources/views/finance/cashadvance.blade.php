...
@if(Session::has('user_id') && Session::get('role_id') == 4)
    ...
    <div class="main-content">
        ...
        <div id="tab-cashadvance" class="tab-panel {{ request('tab') !== 'statutory' ? 'active' : '' }}">
            ...
            <!-- Filter + Add -->
            <form method="GET" action="{{ route('finance.cashadvance') }}" class="filter-form-row">
        ...
        <div id="tab-statutory" class="tab-panel {{ request('tab') === 'statutory' ? 'active' : '' }}">
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:16px; flex-wrap:wrap;">
                <form action="{{ route('finance.cashadvance') }}" method="GET"
    ...
    <div id="cashAdvanceModal" class="modal-overlay" style="display:none;">
        <div class="modal-box">
            ...
            <hr>
            <form method="POST" action="{{ route('finance.cashadvance.store') }}" id="cashAdvanceForm">
                @csrf
                <table>
                    <tbody>
                        <tr>
    ...
    <script>
        ...
        function editCashAdvanceModal(id) {
            fetch(`/finance/cashadvance/${id}/modal`, {
            ...
            .then(data => {
                ...
                document.getElementById('editCashAdvanceForm').action = `/finance/cashadvance/${id}`;
        ...
        function confirmDelete(id) {
            ...
            form.action = `/finance/cashadvance/${id}`;
            form.submit();
        }

        // ── Statutory ──
        const CSRF      = document.querySelector('meta[name="csrf-token"]').content;
        const STORE_URL = "{{ route('finance.statutory.store') }}";
